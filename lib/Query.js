...
Query.prototype.exec = async function (next) {
  ...
  if (this.filterExpressionState && Object.keys(this.filterExpressionState).length > 0) {
    queryReq.FilterExpression = this.filterExpressionState.expression;
    queryReq.ExpressionAttributeNames = {...queryReq.ExpressionAttributeNames || {}, ...this.filterExpressionState.attributeNames};
    queryReq.ExpressionAttributeValues = {...queryReq.ExpressionAttributeValues || {}, ...this.filterExpressionState.attributeValues};
  }
...
Query.prototype.filterExpression = function ({filterExpression, expressionAttributeNames, expressionAttributeValues}) {
  this.filterExpressionState.expression = filterExpression;
  this.filterExpressionState.attributeNames = expressionAttributeNames;
  this.filterExpressionState.attributeValues = expressionAttributeValues;
